        ...
        <>
            <div className='flex flex-row w-screen h-screen items-center justify-center bg-gradient-to-br from-violet-200 py-4 to-white'>
                ...
                <div className='w-[56rem] max-h-[36rem] h-full relative'>
                    ...
                    <div className='absolute inset-y-0 right-[1rem] rounded-bl-4xl rounded-tl-4xl rounded-br-2xl rounded-tr-2xl bg-gray-50 w-[28rem] h-full inline-flex flex-col justify-between items-center px-14 py-8 shadow-xl z-30'>
