...
const PostBox = ({ className, ...props }) => {
    return (
        <div
            {...props}
            className={cn(
                "flex flex-col bg-gray-50 shadow-sm rounded-lg max-h-[20rem] min-h-[23rem] transform transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl overflow-hidden cursor-pointer",
                className
            )}
        >
