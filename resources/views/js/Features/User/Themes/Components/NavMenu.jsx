                                        ...
                                        <div className='p-3 grid grid-cols-2 gap-2'>
                                            {item.subCategories?.map((category, idx) => (
                                                <div key={idx} className="space-y-2">
                                                    <h3 className="text-sm font-semibold text-gray-900 border-b border-violet-800 pb-2 mb-2">
                                                        {category?.name}
                                                    </h3>
                                                    {category?.brands && <ul className="space-y-2">
                                                        {category?.brands.map((subItem) => (
                                                            <li key={subItem?.name}>
                                                                <a
                                                                    href={subItem?.href}
